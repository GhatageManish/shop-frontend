...
const Collection = () => {
  ...
  const applyFilter = () => {
    if (products.length === 0) return; // Wait until products exist
    ...
    setLoading(false); // Stop loading once filter is applied
  }
  ...
  if (loading) {
    return <div className='pt-10 text-center text-gray-500'>Loading products...</div>
  }
